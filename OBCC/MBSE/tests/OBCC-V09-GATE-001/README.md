...
- The emergency-deploy policy and actuator status semantics are controlled by `OBCC-V10_Deployment_Fault_Policy.md`; this rehearsal records observed behavior, status-code/name/category evidence, PDM/actuator confirmation evidence for `OPEN_CONFIRMED`, and deviations against that controlled policy.
