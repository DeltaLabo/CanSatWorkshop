// ======================================================================
// \title  obccTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <obcc/Top/obccTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
// #include <obcc/Top/obccPacketsAc.hpp>
...
// Public functions for use in main program are namespaced with deployment name obcc
namespace obcc {
