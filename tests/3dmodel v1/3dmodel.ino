...
void PackagePayload() {
  ...
  *******/ 
  ...
  floatUnion.value = readAx();
  for (int i=0;i<4;i++) payload[i+8] = floatUnion.bytes[i];
 
  floatUnion.value = readAy(); // Replace with actual function, which must return a float
  ...
  floatUnion.value = readRotx(); // Replace with actual function, which must return a float
  for (int i=0;i<4;i++) payload[i+20] = floatUnion.bytes[i];

  floatUnion.value = readRoty(); // Replace with actual function, which must return a float
  ...
  floatUnion.value = readPitch(); // Replace with actual function, which must return a float
  for (int i=0;i<4;i++) payload[i+32] = floatUnion.bytes[i];

  floatUnion.value = readRoll(); // Replace with actual function, which must return a float
  ...
  floatUnion.value = readSpeed(); // Replace with actual function, which must return a float
