...
def update_graphs1():
    ...
    axVel.set_ylabel('Velocidad', fontsize=12)
    axVel.set_xticklabels([])
    axVel.set_title("Velocidad", fontsize=12)

    axRot.clear()
    axRot.plot(range(len(dataRot1)), dataRot1)
    axRot.set_xlabel('Tiempo', fontsize=12)
    axRot.set_ylabel('Rotación', fontsize=12)
    axRot.set_xticks([])
    axRot.set_title("Rotación", fontsize=12)

    axOri.clear()
    axOri.plot(range(len(dataOri1)), dataOri1)
    axOri.set_xlabel('Tiempo', fontsize=12)
    axOri.set_ylabel('Orientación', fontsize=12)
    axOri.set_xticks([])
    axOri.set_title("Orientación", fontsize=12)

    axAcel.clear()
    axAcel.plot(range(len(dataAce1)), dataAce1)
    axAcel.set_xlabel('Tiempo', fontsize=12)
    axAcel.set_ylabel('Aceleración', fontsize=12)
    axAcel.set_xticks([])
    axAcel.set_title("Aceleración", fontsize=12)

    axAlt.clear()
    axAlt.plot(range(len(dataAlt1)), dataAlt1)
    axAlt.set_xlabel('Tiempo', fontsize=12)
    axAlt.set_ylabel('Altitud', fontsize=12)
    axAlt.set_xticks([])
    axAlt.set_title("Altitud", fontsize=12)

    axVol.clear()
    axVol.plot(range(len(dataVol1)), dataVol1)
    axVol.set_xlabel('Tiempo', fontsize=12)
    axVol.set_ylabel('Voltaje', fontsize=12)
    axVol.set_xticks([])
    axVol.set_title("Voltaje", fontsize=12)

    axCor.clear()
    axCor.plot(range(len(dataCor1)), dataCor1)
    axCor.set_xlabel('Tiempo', fontsize=12)
    axCor.set_ylabel('Corriente', fontsize=12)
    axCor.set_xticks([])
    axCor.set_title("Corriente", fontsize=12)
    ...
    axPos.set_ylabel('Posición', fontsize=12)
    axPos.set_xticks([])
    axPos.set_title("Posición", fontsize=12)
...
def update_graphs2():
    ...
    axVel2.set_ylabel('Velocidad', fontsize=12)
    axVel2.set_xticklabels([])
    axVel2.set_title("Velocidad", fontsize=12)

    axRot2.clear()
    axRot2.plot(range(len(dataRot2)), dataRot2)
    axRot2.set_xlabel('Tiempo', fontsize=12)
    axRot2.set_ylabel('Rotación', fontsize=12)
    axRot2.set_xticks([])
    axRot2.set_title("Rotación", fontsize=12)

    axOri2.clear()
    axOri2.plot(range(len(dataOri2)), dataOri2)
    axOri2.set_xlabel('Tiempo', fontsize=12)
    axOri2.set_ylabel('Orientación', fontsize=12)
    axOri2.set_xticks([])
    axOri2.set_title("Orientación", fontsize=12)

    axAcel2.clear()
    axAcel2.plot(range(len(dataAce2)), dataAce2)
    axAcel2.set_xlabel('Tiempo', fontsize=12)
    axAcel2.set_ylabel('Aceleración', fontsize=12)
    axAcel2.set_xticks([])
    axAcel2.set_title("Aceleración", fontsize=12)

    axAlt2.clear()
    axAlt2.plot(range(len(dataAlt2)), dataAlt2)
    axAlt2.set_xlabel('Tiempo', fontsize=12)
    axAlt2.set_ylabel('Altitud', fontsize=12)
    axAlt2.set_xticks([])
    axAlt2.set_title("Altitud", fontsize=12)

    axVol2.clear()
    axVol2.plot(range(len(dataVol2)), dataVol2)
    axVol2.set_xlabel('Tiempo', fontsize=12)
    axVol2.set_ylabel('Voltaje', fontsize=12)
    axVol2.set_xticks([])
    axVol2.set_title("Voltaje", fontsize=12)

    axCor2.clear()
    axCor2.plot(range(len(dataCor2)), dataCor2)
    axCor2.set_xlabel('Tiempo', fontsize=12)
    axCor2.set_ylabel('Corriente', fontsize=12)
    axCor2.set_xticks([])
    axCor2.set_title("Corriente", fontsize=12)
    ...
    axPos2.set_ylabel('Posición', fontsize=12)
    axPos2.set_xticks([])
    axPos2.set_title("Posición", fontsize=12)
...
def update_graphs3():
    ...
    axVel3.set_ylabel('Velocidad', fontsize=12)
    axVel3.set_xticklabels([])
    axVel3.set_title("Velocidad", fontsize=12)

    axRot3.clear()
    axRot3.plot(range(len(dataRot3)), dataRot3)
    axRot3.set_xlabel('Tiempo', fontsize=12)
    axRot3.set_ylabel('Rotación', fontsize=12)
    axRot3.set_xticks([])
    axRot3.set_title("Rotación", fontsize=12)

    axOri3.clear()
    axOri3.plot(range(len(dataOri3)), dataOri3)
    axOri3.set_xlabel('Tiempo', fontsize=12)
    axOri3.set_ylabel('Orientación', fontsize=12)
    axOri3.set_xticks([])
    axOri3.set_title("Orientación", fontsize=12)

    axAcel3.clear()
    axAcel3.plot(range(len(dataAce3)), dataAce3)
    axAcel3.set_xlabel('Tiempo', fontsize=12)
    axAcel3.set_ylabel('Aceleración', fontsize=12)
    axAcel3.set_xticks([])
    axAcel3.set_title("Aceleración", fontsize=12)

    axAlt3.clear()
    axAlt3.plot(range(len(dataAlt3)), dataAlt3)
    axAlt3.set_xlabel('Tiempo', fontsize=12)
    axAlt3.set_ylabel('Altitud', fontsize=12)
    axAlt3.set_xticks([])
    axAlt3.set_title("Altitud", fontsize=12)

    axVol3.clear()
    axVol3.plot(range(len(dataVol3)), dataVol3)
    axVol3.set_xlabel('Tiempo', fontsize=12)
    axVol3.set_ylabel('Voltaje', fontsize=12)
    axVol3.set_xticks([])
    axVol3.set_title("Voltaje", fontsize=12)

    axCor3.clear()
    axCor3.plot(range(len(dataCor3)), dataCor3)
    axCor3.set_xlabel('Tiempo', fontsize=12)
    axCor3.set_ylabel('Corriente', fontsize=12)
    axCor3.set_xticks([])
    axCor3.set_title("Corriente", fontsize=12)
    ...
    axPos3.set_ylabel('Posición', fontsize=12)
    axPos3.set_xticks([])
    axPos3.set_title("Posición", fontsize=12)
...
def update_graphs4():
    ...
    axVel4.set_ylabel('Velocidad', fontsize=12)
    axVel4.set_xticklabels([])
    axVel4.set_title("Velocidad", fontsize=12)

    axRot4.clear()
    axRot4.plot(range(len(dataRot4)), dataRot4)
    axRot4.set_xlabel('Tiempo', fontsize=12)
    axRot4.set_ylabel('Rotación', fontsize=12)
    axRot4.set_xticks([])
    axRot4.set_title("Rotación", fontsize=12)

    axOri4.clear()
    axOri4.plot(range(len(dataOri4)), dataOri4)
    axOri4.set_xlabel('Tiempo', fontsize=12)
    axOri4.set_ylabel('Orientación', fontsize=12)
    axOri4.set_xticks([])
    axOri4.set_title("Orientación", fontsize=12)

    axAcel4.clear()
    axAcel4.plot(range(len(dataAce4)), dataAce4)
    axAcel4.set_xlabel('Tiempo', fontsize=12)
    axAcel4.set_ylabel('Aceleración', fontsize=12)
    axAcel4.set_xticks([])
    axAcel4.set_title("Aceleración", fontsize=12)

    axAlt4.clear()
    axAlt4.plot(range(len(dataAlt4)), dataAlt4)
    axAlt4.set_xlabel('Tiempo', fontsize=12)
    axAlt4.set_ylabel('Altitud', fontsize=12)
    axAlt4.set_xticks([])
    axAlt4.set_title("Altitud", fontsize=12)

    axVol4.clear()
    axVol4.plot(range(len(dataVol4)), dataVol4)
    axVol4.set_xlabel('Tiempo', fontsize=12)
    axVol4.set_ylabel('Voltaje', fontsize=12)
    axVol4.set_xticks([])
    axVol4.set_title("Voltaje", fontsize=12)

    axCor4.clear()
    axCor4.plot(range(len(dataCor4)), dataCor4)
    axCor4.set_xlabel('Tiempo', fontsize=12)
    axCor4.set_ylabel('Corriente', fontsize=12)
    axCor4.set_xticks([])
    axCor4.set_title("Corriente", fontsize=12)
    ...
    axPos4.set_ylabel('Posición', fontsize=12)
    axPos4.set_xticks([])
    axPos4.set_title("Posición", fontsize=12)
