// ======================================================================
// \title  obccTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef OBCC_OBCCTOPOLOGY_HPP
#define OBCC_OBCCTOPOLOGY_HPP
// Included for access to obcc::TopologyState and obcc::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <obcc/Top/obccTopologyDefs.hpp>

// Remove unnecessary obcc:: qualifications
using namespace obcc;
namespace obcc {
/**
 ...
 * obcc::TopologyState see: obccTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type obcc::TopologyState see: obccTopologyDefs.hpp.
 *
