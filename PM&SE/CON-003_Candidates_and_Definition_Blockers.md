...
| SYS-BLK-003 | As-built configuration not frozen; naming drift exists (`RFM95W`/`RFM96W`, `ICM20948`/`MPU6050`, `BME280`/`BMP280`, battery architecture). | Validity of evidence and cross-subsystem traceability. | Freeze as-built BOM/configuration and disposition model/code naming differences. |
