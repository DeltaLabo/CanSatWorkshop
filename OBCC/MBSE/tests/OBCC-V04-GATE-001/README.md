...
|---|---|---|---|
| PV1 physical setup | `OBCC-V04-GATE-001_view1_test_physical_setup.d2` | `OBCC-V04-GATE-001_view1_test_physical_setup.png` | UUT, RFM96W radio path, ground command transmitter, RF monitor, telemetry observer, bench USB aid, deployment safe-load/logic probe, and ambient thermometer physical links. |
