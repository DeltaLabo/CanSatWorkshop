...
final_url: "https://www.thethingsnetwork.org/docs/lorawan/duty-cycle/"
title: "Duty Cycle"
extracted_at: "2026-06-11T22:24:45.729840+00:00"
...
## Maximum Duty Cycle [#](https://www.thethingsnetwork.org#maximum-duty-cycle)
...
**K**(863 MHz - 865 MHz): 0.1%**L**(865 MHz - 868 MHz): 1%**M**(868 MHz - 868.6 MHz): 1%**N**(868.7 MHz - 869.2 MHz): 0.1%**P**(869.4 MHz - 869.65 MHz): 10%**Q**(869.7 MHz - 870 MHz): 1%
...
#### Fair Use Policy [#](https://www.thethingsnetwork.org#fair-use-policy)
...
## Compliance [#](https://www.thethingsnetwork.org#compliance)
...
. Specifically, the RN2483 limits the duty cycle on a per-channel basis. This means that if you only have 1 channel configured, the module will start enforcing the duty cycle after the first message.
